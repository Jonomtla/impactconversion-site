...
const sections: { title: string; body: string[] }[] = [
  ...
  },
  {
    title: "How we use it",
    body: [
      "To respond to your enquiries, run discovery conversations, send proposals, and deliver services you’ve engaged us for.",
  ...
  },
  {
    ...
    body: [
      ...
      "We do not sell your information. We only share what’s needed for each service to function and require each provider to keep it secure.",
  ...
  },
  {
    title: "Your rights",
    body: [
      "You can ask us what information we hold about you, correct anything inaccurate, or request deletion where we don’t need to keep it for legal reasons. Email jono@impactconversion.com and we’ll respond within 20 working days as required by the Privacy Act 2020.",
      "If you’re in the EU/UK, you have equivalent rights under the GDPR/UK GDPR, with the same request process and the same contact.",
    ],
  },
  {
    title: "Security",
    body: [
      "We store records in vendor-hosted systems with standard security (encrypted at rest and in transit). We don’t store payment card details ourselves.",
      "No system is ever fully secure. If we become aware of a breach affecting your data we’ll notify you and the Privacy Commissioner as required.",
    ],
  },
  {
    title: "International transfers",
    body: [
      "Most of our providers are based in the US or EU. When we transfer your data outside New Zealand we rely on the providers’ standard contractual clauses and security commitments.",
    ],
  },
  {
    title: "Changes",
  ...
  },
  {
    title: "Complaints",
    body: [
      "If you’re not happy with how we’ve handled your information, you can complain to us at jono@impactconversion.com, or to the Office of the Privacy Commissioner at privacy.org.nz.",
    ],
  },
];
