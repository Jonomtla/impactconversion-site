        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
          <div>
            <h2 className="text-balance text-4xl font-semibold tracking-tight text-text md:text-5xl">
              <span className="text-gradient-purple">Specialists</span> only
            </h2>
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl bg-white border border-ink/10 p-6">
                ...
                <p className="mt-2 text-2xl font-semibold text-text">US, AU, APAC</p>
                <p className="mt-1 text-sm text-text-muted">The timezone never gets in the way.</p>
              </div>
            </div>
            ...
            <div className="mt-4 rounded-2xl bg-white border border-ink/10 p-6">
              ...
              <p className="mt-4 text-base text-text">
                Every engagement is run by Jono and specialists. No account
          ...
          <div className="space-y-6 text-lg leading-relaxed text-text-muted">
            <p>
              ...
              charging good companies $100k for redesigns, only for the new
              website to make less sales. How do you explain that one to the
              finance team?
            </p>
            <p>
              Profit moves when you find what is working, what&apos;s not,
              test the fix, and keep what works, month after month. This
              isn&apos;t a quick fix, it&apos;s a program that dramatically
              increases your sales using the data.
            </p>
            <p>
              So that is all we do. We keep a small number of clients on long
              engagements with deep relationships, and every test gets
              documented so we know what actually makes a difference.
            </p>
            <p>
            ...
            <p className="text-text font-medium">
              If you&apos;re sick of spending more on ads with not much more
              to show for it, let&apos;s talk.
            </p>
          </div>
        </div>
      </div>
