      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
          <div>
            ...
            <div className="mt-10 rounded-2xl bg-white border border-ink/10 p-6">
              <p className="text-sm uppercase tracking-wider text-text-muted">Based in</p>
              <p className="mt-2 text-2xl font-semibold text-text">Queenstown, NZ</p>
              <p className="mt-4 text-sm uppercase tracking-wider text-text-muted">Working with brands in</p>
              <p className="mt-2 text-lg text-text">US. AU. EU. APAC.</p>
            </div>
          </div>
          <div className="space-y-6 text-lg leading-relaxed text-text-muted">
            ...
            <p>
              ...
              thing, and keeping what works.
            </p>
            <p>
              So we do that. And only that. Small number of clients. Long
              engagements. Deep relationships. If that sounds like what your
              current setup is missing, let&apos;s talk.
            </p>
          </div>
        </div>
      </div>
