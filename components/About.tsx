      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-text-muted">
            ...
            <p>
              We research why customers leave, test changes against the live
              site, and measure their effect on sales. Successful changes stay
              live, and each result helps us choose what to test next.
            </p>
            <p>
              So that is all we do. We keep a small number of clients on long
              engagements with deep relationships, and every test gets
              documented so we know which changes made a difference.
            </p>
            <p>
