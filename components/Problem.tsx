...
const pillars = [
  {
    ...
    p: "Many visitors arrive interested and leave because the page does not answer the question holding them back. We find those unanswered questions and test where and how the site should address them.",
    Visual: LeakyFunnel,
  },
  {
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <Reveal className="max-w-3xl">
          ...
          <p className="mt-4 text-lg text-text-muted">
            If you&apos;re pouring more water into a leaky bucket, buying more
            traffic makes the leak more expensive.
          </p>
          <p className="mt-4 text-lg text-text-muted">
          ...
          <p className="mt-4 text-lg text-text-muted">
            Or, you could figure out what converts your customers. Why
          ...
          <p className="mt-4 text-lg text-text-muted">
            Ads mostly influence customer acquisition and repeat purchases.
            CRO can also test order value, purchase frequency and pricing.
          </p>
          <p className="mt-4 text-lg font-medium text-text">
            Here&apos;s how:
          </p>
